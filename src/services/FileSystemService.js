...
var FileSystemService = /** @class */ (function () {
     ...
     */
    FileSystemService.prototype.fileExists = function (filePath) {
     ...
     */
    FileSystemService.prototype.writeFile = function (filePath, content) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, fs_1.promises.mkdir(path_1.default.dirname(filePath), { recursive: true })];
                    case 1:
                        _a.sent();
     ...
     */
    FileSystemService.prototype.readFile = function (filePath) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
     ...
     */
    FileSystemService.prototype.ensureDir = function (dirPath) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, fs_1.promises.mkdir(dirPath, { recursive: true })];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
