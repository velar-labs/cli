...
exports.add = new commander_1.Command()
    ...
    var errorHandler, options, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                options = exports.addOptionsSchema.parse(__assign({ components: components, cwd: path_1.default.resolve(opts.cwd) }, opts));
                return [4 /*yield*/, (0, add_components_1.addComponents)(options)];
            case 2:
                _a.sent();
                return [3 /*break*/, 4];
            case 3:
                error_1 = _a.sent();
                errorHandler.handle(error_1, "add command");
                process.exit(1);
                return [3 /*break*/, 4];
